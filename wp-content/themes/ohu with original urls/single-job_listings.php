...
<div style="float:left;border:1px solid #757575;height:100%;width:220px;margin-left:-70px;padding:20px;margin-bottom:20px;margin-top:-73px;">
...
<div class="entry-content" style="width:620px;margin-top:-95px;float:right;margin-right:-70px;">
...
?></span><br />
<a href="http://new.onehopeunited.org" class="graytext" style="font-weight:normal;">Home</a> > <a href="http://new.onehopeunited.org/careers/" class="graytext" style="font-weight:normal;">Careers</span></a> > <a href="http://new.onehopeunited.org/careers/<?php meta('job-region'); ?>" class="redtext"><?php meta('job-region'); ?> Region</a></span>
</div> 

<div class="entry-content" style="width:620px;float:right;margin-right:0px;margin-top:0px;">

<div style="margin-bottom:20px;">
<img src="http://new.onehopeunited.org/wp-content/themes/ohu/images/<?php $jobstate = get_post_meta($post->ID,'job-listing-state1',true);
...
<img src="http://new.onehopeunited.org/wp-content/themes/ohu/images/bwfoster.jpg" style="float:right;margin-left:10px;margin-right:10px;">
...
<table><tr><td style="line-height:1em;border-bottom:1px solid white;">
	...
	<span class="redtext">CONTACT</span> recruiter@onehopeunited.org</td></tr></table>
	</div>
