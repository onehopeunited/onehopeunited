...
<b>GUIDESTAR</b>
<ul class="sidebar-links">
<li><a href="http://www.guidestar.org/organizations/54-2082539/one-hope-united-florida-region.aspx" target="_blank">Central Florida Region</a></li>
</ul>

<B>CASE FOR SUPPORT</B>
<ul class="sidebar-links">
<li><a href="http://www.onehopeunited.org/make_a_gift/case_for_support_FR.pdf">Central Florida Region</a></li>
</ul>
...
<br />
Our needs range from Band-Aids to buildings! Please check our <a href="http://new.onehopeunited.org/get-involved/get-involved-in-florida/florida-region-wish-list/">Wish Lists</a>. For more information or to arrange delivery of your donations, please contact:
 <br /><br />
Maria Weber<br />
407-379-2904<br />
mweber@onehopeunited.org
</div>
</div>
...
<hr>
		<img src="http://new.onehopeunited.org/wp-content/themes/ohu/images/volunteer-button.gif" style="margin-top:-24px;margin-bottom:10px;">
		
				<img src="http://new.onehopeunited.org/wp-content/themes/ohu/images/events-button.gif" style="margin-top:-24px;margin-bottom:10px;float:right;margin-right:170px;">
		<table>
		<tr>
		<td width="300">
