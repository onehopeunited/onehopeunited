<?php
/*
Template Name: Careers: Huddleson
*/
get_header(); ?>
...
<span style="font-size:1.3em;font-weight:normal;"> Central & Southern Illinois / Missouri</span><br />
<a href="http://new.onehopeunited.org" class="graytext" style="font-weight:normal;">Home</a> > <a href="http://new.onehopeunited.org/careers/" class="graytext" style="font-weight:normal;">Careers</span></a> > <a href="http://new.onehopeunited.org/careers/<?php meta('job-region'); ?>" class="redtext">Hudelson Region</a></span>
</div> 
...
<img src="http://new.onehopeunited.org/wp-content/themes/ohu/images/jobs-hudelson.jpg" style="float:left;margin-right:20px;">
...
<div style="">
	...
	<tr><th style="border-bottom:1px solid black;">Job Title</th><th style="border-bottom:1px solid black;">Job Location</th><th style="border-bottom:1px solid black;">Job Type</th></td>	<?php $querystr = "
SELECT wposts.*
FROM $wpdb->posts wposts, $wpdb->postmeta wpostmeta
WHERE wposts.ID = wpostmeta.post_id
AND wpostmeta.meta_key = 'job-region'
AND wpostmeta.meta_value = 'Hudelson'
...
<tr>
<td><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></td> <td><?php meta('job-listing-city'); ?>, <?php meta('job-listing-state1'); ?></td></td><td><?php meta('job-listing-duration'); ?></td>
</tr>
