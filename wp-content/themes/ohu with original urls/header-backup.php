...
<div id="page" class="hfeed">
	<header id="branding" role="banner">
			...
			<div style="float:right;margin-right:50px;margin-top:-2px;">	
			<a href="http://onehopeunited.org/donate/"><img src="http://new.onehopeunited.org/wp-content/themes/ohu/images/donate.png"></a>
			</div>
			
<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="http://new.onehopeunited.org/wp-content/themes/ohu/images/ohu-banner-strip.png" style="margin-top:50px;margin-bottom:50px;"></a>
							</hgroup>
