...
<li><a href="<?php echo get_bloginfo('url');?>/careers/northern/">Northern Illinois / Wisconsin</a></li>
<li><a href="<?php echo get_bloginfo('url');?>/careers/hudelson/">Central & Southern Illinois / Missouri</a></li>
<li><a href="<?php echo get_bloginfo('url');?>/careers/florida/">Florida Region</a></li>
</ul>
...
<div style="background:#3991c3;width:620px;color:white;height:230px;"><img src="<?php echo get_bloginfo('url');?>/wp-content/themes/ohu/images/careers-image.jpg" style="float:left;">
...
<img src="<?php echo get_bloginfo('url');?>/wp-content/themes/ohu/images/available-careers.gif" style="float:left;margin-top:1px;">
...
<div style="width:300px;float:left;margin-top:70px;margin-left:-140px;">
	...
	<img src="<?php echo get_bloginfo('url');?>/wp-content/themes/ohu/images/job-opportunities.gif" style="margin-top:20px;"><br />
	

	<a href="<?php echo get_bloginfo('url');?>/careers/northern/" class="redtext">> NORTHERN ILLINOIS / WISCONSIN</a><br /><br />
    <a href="<?php echo get_bloginfo('url');?>/careers/hudelson/" class="redtext">> CENTRAL & SOUTHERN ILLINOIS /<br />&nbsp;&nbsp; MISSOURI</a><br />
    <br />
    	<a href="<?php echo get_bloginfo('url');?>/careers/florida/" class="redtext">> FLORIDA REGION</a><br /><br />
