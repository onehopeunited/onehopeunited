...
<a href="<?php the_permalink(); ?>">Permalink to Article</a> &nbsp;&nbsp;|&nbsp;&nbsp; Share:  <a href="https://twitter.com/share?url=http://onehopeunited.org/?p=<?php the_ID(); ?>&text=<?php the_title(); ?> -" target="_blank"><img src="http://onehopeunited.org/wp-content/themes/ohu/images/twitter.png"></a> &nbsp;&nbsp; 
<a title="Share this on Facebook" target="_blank" href="http://www.facebook.com/sharer.php?s=100&p[url]=<?php the_permalink() ?>&p[images][0]=<?php $key="thumbnail"; echo get_post_meta($post->ID, $key, true); ?>&p[title]=<?php the_title(); ?>&p[summary]=<?php echo excerpt(30); ?>"><img src="http://onehopeunited.org/wp-content/themes/ohu/images/facebook.png"></a></div>
