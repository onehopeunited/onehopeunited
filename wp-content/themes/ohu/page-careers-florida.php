...
<a href="<?php echo get_bloginfo('url');?>" class="graytext" style="font-weight:normal;">Home</a> > <a href="<?php echo get_bloginfo('url');?>/careers/" class="graytext" style="font-weight:normal;">Careers</span></a> > <a href="<?php echo get_bloginfo('url');?>/careers/<?php meta('job-region'); ?>" class="redtext">Florida Region</a></span>
</div>
<div style="width:600px;height:100px;">
<img src="<?php echo get_bloginfo('url');?>/wp-content/themes/ohu/images/jobs-florida.jpg" style="float:left;margin-right:20px;">
            ...
            $availableCities = $wpdb->get_results(
                "SELECT DISTINCT meta_value FROM wp_postmeta
                    ...
                    WHERE wp_postmeta.meta_key='job-listing-city'
                        ...
                        AND wp_postmeta.meta_value = 'Florida'
                        AND wp_posts.post_status = 'publish'
                        AND wp_posts.post_type = 'job_listings')
            ...
            if ($cityList):
                foreach ($cityList as $city):
                    foreach ($city as $post):
                        setup_postdata($post); ?>
                        <tr>
                            <td><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></td> <td><?php meta('job-listing-city'); ?></td><td><?php meta('job-listing-duration'); ?></td>
                        </tr>
