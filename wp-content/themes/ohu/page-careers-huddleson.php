...
<a href="<?php echo get_bloginfo('url');?>" class="graytext" style="font-weight:normal;">Home</a> > <a href="<?php echo get_bloginfo('url');?>/careers/" class="graytext" style="font-weight:normal;">Careers</span></a> > <a href="<?php echo get_bloginfo('url');?>/careers/<?php meta('job-region'); ?>" class="redtext">Hudelson Region</a></span>
</div> 
...
<img src="<?php echo get_bloginfo('url');?>/wp-content/themes/ohu/images/jobs-hudelson.jpg" style="float:left;margin-right:20px;">
            ...
            $availableCities = $wpdb->get_results(
                "SELECT DISTINCT meta_value FROM wp_postmeta
                    ...
                    WHERE wp_postmeta.meta_key='job-listing-city'
                        ...
                        AND wp_postmeta.meta_value = 'Hudelson'
                        AND wp_posts.post_status = 'publish'
                        AND wp_posts.post_type = 'job_listings')
