<?php
	...
	define('CA_REQUIRED_PAGE', 'options-general.php');
	
	if( !defined( "AS_CURRENT_PAGE" ) )
		define( "AS_CURRENT_PAGE", basename( $_SERVER['PHP_SELF'] ) );
	
	if( !defined('CODEART_PLUGIN') || AS_CURRENT_PAGE !== CA_REQUIRED_PAGE ) exit('Access denied...'); 
...
<div class="ca-google-mp3-audio-player">
    ...
    <div class="ca-google-mp3-audio-player-content">
    	<ul>
            ...
            <li>
                ...
                <p>
                    ...
                    <textarea rows="2" cols="105">[ca_audio url="URL" width="WIDTH" height="HEIGHT" css_class="CSS_CLASS"]</textarea>
                    <ul class="ca-options-description">
                        ...
                        <li><strong>CSS_CLASS</strong> - This is for the developers.</li>
                    </ul>
        ...
        <div class="code-art-watermark">
        	...
        	<img align="absbottom" src="<?php echo $image_url; ?>" width="71" height="55" alt="CodeArt Watermark" />
        </div>
